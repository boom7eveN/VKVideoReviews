...
{
    Task<ReviewModel> CreateReviewAsync(Guid userId, Guid videoId, CreateReviewModel model);
    ...
    Task<ReviewModel> UpdateReviewAsync(Guid userId, Guid videoId, UpdateReviewModel model);
}